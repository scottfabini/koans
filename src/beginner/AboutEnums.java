...
public class AboutEnums {
    ...
    enum Colors {
        Red, Blue, Green, Yellow // what happens if you add a ; here? Unnecessary semicolon warning.
        // What happens if you type Red() instead? No change.
    }
    ...
    public void enumsWithAttributes() {
        ...
        // because we are within the AboutEnums class, and can thus access inner-Enum and
        // inner-Class variables.
        // Try moving the enum outside the AboutEnum class... What do you expect?
        // What happens?
        // Unable to compile.  Unable to access private data.
