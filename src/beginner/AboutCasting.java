...
public class AboutCasting {
    ...
    public void downCastWithInheritance() {
        ...
        Parent parentReference = child; // Why isn't there an explicit cast? Child is a parent.
    ...
    public void upCastWithInheritance() {
        ...
        Parent parentReference = (Parent) child; // Why do we need an explicit cast here? Child extends parent.  Not the other way around
        Child childReference = (Child) parentReference; // Or here? To make the downcast to a child object
